...
QJ.MPMZ.tl._imoutoUtilStateText = {
        ...
        29: { // 洗澡状态
            ...
            description: {
                ...
                2: {
                    4: "✦\\fi\\c[110]Imouto is drying her hair \nwith a towel",
                    default: "✦\\fi\\c[110]Imouto is bathing,\nher figure barely visible"
                }
            }
        },
        32: { // 肚子饿状态
            ...
            description: {
                ...
                2: [
                    "✦\\fi\\c[110]Imouto is quietly waiting \nfor dinner",
                    "✦\\fi\\c[110]Imouto seems a bit worried \nabout the dinner taste…",
                    "✦\\fi\\c[110]Imouto appears like she \nwants to help"
                ]
            }
        }
};
    ...
    function getRestingDescription(lang, mood) {
        var texts = {
            ...
            2: {
                high: [
                    "✦\\fi\\c[110]Imouto looks very happy,\nAnything interesting happen?",
                    "✦\\fi\\c[110]Imouto is getting cuter,\nMaybe give her a pats!"
                ],
                mid: "✦\\fi\\c[110]Imouto is just sitting \nthere. Try talking to her…",
                low: [
                    "✦\\fi\\c[110]Imouto looks a bit sad,\nMaybe try comforting her?",
                    "✦\\fi\\c[110]Imouto seems a bit off,\nWonder what could be done…"
                ],
                sleep: "✦\\fi\\c[110]Imouto looks sleepy,\nMaybe it's time for bed?"
            }
        };
    ...
    function getSleepDescription(lang, sleepDesire) {
        var texts = {
            ...
            2: {
                high: "✦\\fi\\c[110]Imouto is almost awake,\nbut her senses are still hazy.",
