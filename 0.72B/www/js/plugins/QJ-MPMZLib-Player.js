...
QJ.MPMZ.tl.ex_playerStuckCheck = function() {
    ...
    if ((noPass && !canThrough) ||
        (!canThrough && !canMoveUp && !canMoveDown && !canMoveLeft && !canMoveRight)) {
...
QJ.MPMZ.tl.ex_playerFallCheck = function() {
	...
	var condition2 = !$gameSwitches.value(320);
...
QJ.MPMZ.tl.ex_punchAttackListener = function() {
    ...
    if ($gameMap.getGroupBulletListQJ('weaponBroken').length > 0) {
       ...
       QJ.MPMZ.Shoot({
            ...
            moveF: [
			  [time,0,QJ.MPMZ.tl.ex_playerLeftPunchAttack],
