...
QJ.MPMZ.tl.ex_frostFlameThrower = function(BID) {
  ...
  QJ.MPMZ.Shooter_ArcRange(iniRotation,{
    ...
    existData:[
    {t:['Time',time],d:[0,20]},
	{t:['G',['"enemy"','"object"']],a:['F',QJ.MPMZ.tl.ex_toEnemyAttack,[magicDamage,{magicAttack:true,noHitEffect:true,noDurLoss:true,specifyAddedStatus:true}]],c:['S','Math.random()>0.5']},
