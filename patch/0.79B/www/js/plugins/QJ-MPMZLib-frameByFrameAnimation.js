...
QJ.MPMZ.tl._imoutoUtilWashRoomImoutoTekokiAction = function(type) {
	...
	//var panties = "washroom_tekoki_whitePanties" + this._frames;
...
QJ.MPMZ.tl._imoutoUtilWashRoomImoutoTekokiAction2 = function(type) {
	...
	//var panties = "washroom_tekoki_action2_whitePanties_" + this._frames;
	//$gameScreen.showPictureFromPath(19, "washroom_tekoki", panties, 0, 360, 0, 100, 100, 255, 0);
...
QJ.MPMZ.tl._imoutoUtilWashRoomImoutoTekokiAction3 = function(type) {
	...
	//var panties = "washroom_tekoki_action3_whitePanties_" + this._frames;
	//$gameScreen.showPictureFromPath(19, "washroom_tekoki", panties, 0, 360, 0, 100, 100, 255, 0);
...
QJ.MPMZ.tl._imoutoUtilWashRoomImoutoTekokiAction4 = function(type) {
	...
	//var panties = "washroom_tekoki_action4_whitePanties_" + this._frames;
	//$gameScreen.showPictureFromPath(19, "washroom_tekoki", panties, 0, 360, 0, 100, 100, 255, 0);		
