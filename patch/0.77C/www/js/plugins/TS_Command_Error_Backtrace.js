...
Game_Interpreter.prototype.executeCommand = function () {
    ...
    SceneManager.catchException = function(e) {
        ...
        setTimeout(function(){
			...
			// 检测到新版本就提醒去更新
			let RemindToUpdate = $gameStrings.value(1) !== "" || $gameVariables.value(2) !== 0;
			if (RemindToUpdate) {
				textArray = window.systemFeatureText['RemindToUpdate'][String(lang)];
			} 		
			  ...
			  if (RemindToUpdate) {
				 location.reload();
				  ...
				  if (Utils.isMobileDevice()) {
                    window.open('https://discord.gg/9dPrpYwsM9', '_system');
                  } else {
