...
QJ.MPMZ.tl.ex_playerFallCheck = function() {
	...
	// 确实处于踩空状态没有借助落脚点
	var condition1 = !$gameSwitches.value(188) && $gameMap.regionId( Math.floor($gamePlayer.centerRealX()), Math.floor($gamePlayer.centerRealY()) ) === 250;
...
// 闪步残像生成
QJ.MPMZ.tl.ex_senpoResidualEffect = function(user,color = [0,0,0,0],IsActionSequence = null, zIndex) {
