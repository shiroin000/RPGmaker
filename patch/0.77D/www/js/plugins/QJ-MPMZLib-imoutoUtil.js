...
QJ.MPMZ.tl._imoutoUtilStateText = {
        34: { // 刷牙状态
            ...
            description: {
                0: "✦\\fi\\c[110]懒散地刷牙中、\n还一副没睡醒的模样……",
                1: "✦\\fi\\c[110]だらだらと歯を磨いて、\nまだ完全に目が覚めていない様子……",
                2: "✦\\fi\\c[110]Lazily brushing her teeth, \nstill looking half-asleep…"
            }
        },
        33: { // 乘凉状态
            setValue: {
            ...
            description: {
                0: "✦\\fi\\c[110]妹妹正在惬意地舔着冰棒、\n但有点太没防备的样子了……",
                1: "✦\\fi\\c[110]妹はアイスキャンディーを楽しんでいるが、\n少し油断している様子……",
                2: "✦\\fi\\c[110]She’s lazily licking a popsicle,\nbut she looks too unguarded…"
            }
        },
        28: { // 玩游戏状态
            setValue: {
            ...
            description: {
                ...
                1: [
                    "✦\\fi\\c[110]妹は一心不乱にゲーム中、\n邪魔しない方がいいかも…",
                    "✦\\fi\\c[110]まだゲーム中…\nからかってみる？"
                ],
                2: [
                    "✦\\fi\\c[110]She’s really focused on the game, \nso it’s better not to disturb her too much…",
                    "✦\\fi\\c[110]She’s still playing... \nShould I tease her a bit?"
                ]
            }
        },
        29: { // 洗澡状态
            ...
            description: {
                0: {
                    4: "✦\\fi\\c[110]妹妹正在用毛巾擦干头发",
                    default: "✦\\fi\\c[110]正在洗澡的妹妹、\n依稀能看见身影"
                },
                1: {
                    4: "✦\\fi\\c[110]妹はタオルで髪を乾かしている",
                    default: "✦\\fi\\c[110]入浴中の妹、\nかすかに姿が見える"
                },
                2: {
                    4: "✦\\fi\\c[110]Sister is drying her hair \nwith a towel",
                    default: "✦\\fi\\c[110]Sister is bathing,\nher figure barely visible"
                }
            }
        },
        32: { // 肚子饿状态
            ...
            description: {
                0: [
                    "✦\\fi\\c[110]妹妹在静静地等着晚饭。",
                    "✦\\fi\\c[110]妹妹好像有点担心晚饭的味道…",
                    "✦\\fi\\c[110]妹妹似乎想要帮忙的样子。"
                ],
                1: [
                    "✦\\fi\\c[110]妹は静かに夕食を待っている。",
                    "✦\\fi\\c[110]妹は夕食の味を少し心配しているようだ…",
                    "✦\\fi\\c[110]妹は手伝いたそうな様子だ。"
                ],
                2: [
                    "✦\\fi\\c[110]Sister is quietly waiting \nfor dinner",
                    "✦\\fi\\c[110]Sister seems a bit worried \nabout the dinner taste…",
                    "✦\\fi\\c[110]Sister appears like she \nwants to help"
                ]
            }
        }
};
    ...
    function getRestingDescription(lang, mood) {
        var texts = {
            0: {
                ...
                mid: "✦\\fi\\c[110]妹妹只是呆呆地坐在那。\n去试试找她搭话吧…",
                low: [
                    "✦\\fi\\c[110]妹妹看起来有点难过、\n去安慰看看吧？",
                    "✦\\fi\\c[110]妹妹看起来有点不舒服、\n该做点什么好呢…"
                ],
                sleep: "✦\\fi\\c[110]妹妹看起来已经困了、\n差不多该去睡觉了吧？"
            },
            1: {
                high: [
                    "✦\\fi\\c[110]楽しそうな顔をしている妹、\n何か面白いものでも見たのかな？",
                    "✦\\fi\\c[110]どんどん可愛くなる妹\n頭を撫でてあげよう!"
                ],
                mid: "✦\\fi\\c[110]妹がただぼんやり座ってるな。\n話しかけた方がいいかな…",
                low: [
                    "✦\\fi\\c[110]妹がちょっと悲しそうだな、\n慰めてみるか？",
                    "✦\\fi\\c[110]妹が元気なさそうだけど、\nどうしたらいいかな…"
                ],
                sleep: "✦\\fi\\c[110]妹はすでに眠そう、\nそろそろ寝る時間かも？"
            },
            2: {
                high: [
                    "✦\\fi\\c[110]Sister looks very happy,\nDid something interesting happen?",
                    "✦\\fi\\c[110]Sister is getting cuter,\nMaybe give her a pat on the head!"
                ],
                mid: "✦\\fi\\c[110]Sister is just sitting \nthere. Try talking to her…",
                low: [
                    "✦\\fi\\c[110]Sister looks a bit sad,\nMaybe try comforting her?",
                    "✦\\fi\\c[110]Sister seems a bit off,\nWonder what could be done…"
                ],
                sleep: "✦\\fi\\c[110]Sister looks sleepy,\nMaybe it's time for bed?"
            }
        };
    ...
    function getSleepDescription(lang, sleepDesire) {
        var texts = {
            0: {
                high: "✦\\fi\\c[110]妹妹快要醒过来了、\n但意识还有些模糊。",
                mid: "✦\\fi\\c[110]看起来半梦半醒着、\n无意识地发出呢喃。",
                low: "✦\\fi\\c[110]睫毛抖动着、\n隐约能听到在说什么梦话。",
                lower: "✦\\fi\\c[110]睡得很安稳、\n完全沉浸在睡梦中…",
                veryLow: "✦\\fi\\c[110]爆睡中…\n看起来是很难醒过来了。",
                default: "✦\\fi\\c[110]像植物一样陷入了沉睡…\n怎么都叫不起来了…"
            },
            1: {
                high: "✦\\fi\\c[110]妹はもうすぐ目を覚ます、\nでも意識はまだ朦朧としている。",
                mid: "✦\\fi\\c[110]半分夢の中、\n何かを呟いている。",
                low: "✦\\fi\\c[110]まぶたが震え、\n夢の中の囁きが聞こえる。",
                lower: "✦\\fi\\c[110]ぐっすり眠っている、\n夢の世界に浸っている…",
                veryLow: "✦\\fi\\c[110]ぐっすり寝て、\n起こすのが難しそう。",
                default: "✦\\fi\\c[110]植物のように眠り続け…\n起こせそうにない。"
            },
            2: {
                high: "✦\\fi\\c[110]Sister is almost awake,\nbut her senses are still hazy.",
                mid: "✦\\fi\\c[110]She seems half-awake,\nmurmuring unintentionally.",
                low: "✦\\fi\\c[110]Her eyelashes twitch,\nas if murmuring in a dream.",
                lower: "✦\\fi\\c[110]Sleeping soundly,\ncompletely immersed in her dreams…",
                veryLow: "✦\\fi\\c[110]Deep asleep…\nIt seems hard to wake her.",
                default: "✦\\fi\\c[110]Asleep like a plant…\nunable to be roused."
            }
        };
        if (sleepDesire >= 70) {
...
QJ.MPMZ.tl._imoutoUtilautoUpdataCheck = function() {
    ...
    var url = "https://script.google.com/macros/s/AKfycbwA7sOGJ_Q7oYTsmX16bIXIQFfcuZcVXGgagtfyHigvcwo8_zHmRDjLgeGafLWBTnIO/exec"
            + "?mode=LatestVersion"
			+ "&lang=" + userLang
			+ "&version=" + versionA;				
...
QJ.MPMZ.tl._imoutoUtilBeginnersGuide = function(guideIndex) {
    ...
    var guideTextArray = window["MapEventDialogue4"]["AndroidBeginnersGuide"][guide.index];
	...
	let FontSize = 28;
    // 移动端适配
    if (Utils.isMobileDevice())  FontSize = 32;
